                ...
                <div class="card-body">
                    <form action="{{ route('item.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            @if ($item->photo)
                                <p>Foto saat ini: <img src="{{ asset('photos/' . $item->photo) }}" alt="Photo Item" width="100"></p>
                            @endif
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('unique_code') is-invalid @enderror" name="unique_code" id="unique_code" placeholder="Contoh: MM-001" value="{{ old('unique_code', $item->unique_code) }}">
                            @error('unique_code')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
